...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API del Sistema de Asambleas PH (Propiedad Horizontal) - Backend Laravel 12 con arquitectura multi-tenant por base de datos.',
    ],
    ...
    'ui' => [
         ...
         */
        'title' => 'API Sistema de Asambleas PH',
     ...
     * En desarrollo, puedes quitar RestrictedDocsAccess::class para acceso libre.
     * En producción, se recomienda mantenerlo o crear un middleware personalizado.
     */
    'middleware' => [
        'web',
