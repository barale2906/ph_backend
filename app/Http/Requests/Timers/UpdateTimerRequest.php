...
/**
 * Request para actualizar un cronómetro.
 * 
 * Valida los datos necesarios para actualizar un timer existente.
 */
class UpdateTimerRequest extends FormRequest
{
    ...
    {
        return [
            'tipo' => ['sometimes', 'string', 'in:INTERVENCION,VOTACION'],
            'duracion_segundos' => ['sometimes', 'integer', 'min:1', 'max:3600'],
